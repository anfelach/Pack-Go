  ...
  <option value="Relizane">Relizane</option>
    ...
    <div class="errors"><?php
        ...
        if (isset($_POST["heredone"])) {
            ...
            if (empty($name) OR empty($email) OR empty($password) OR empty($wilaya) OR empty($phonenum)) {
            ...
            if (count($errors)>0) {
                ...
                if ($prepareStmt) {
                    mysqli_stmt_bind_param($stmt,"ssssib",$name, $email, $passwordHash, $wilaya, $phonenum, $profile);
