...
<head>
    ...
    <link rel="stylesheet" href="login_agency.css">
...
<body>
    ...
    <div class="right">
        <form action="login_agency.php" method="post" class="Login">
            <h1>Log in</h1>
            <div class="input-box">
                ...
                <a href="Signup_agency.php" class="Signup">Sign up</a>
                <a class="client_login" href="login.php">login as a client</a>
            </div>
        </form>
        <?php
            session_start();
