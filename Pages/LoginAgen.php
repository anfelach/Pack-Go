            ...
            <div class="booking p-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        <h1 class="text-white mb-4">Log in as an Agency</h1>
                    </div>
                    <div class="col-md-6">
                        <h1 class="text-white mb-4">Agency Informations</h1>
                        <form action="../php/AgenloginFun.php" method="post">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input type="password" class="form-control bg-transparent datetimepicker-input" name="psw" id="password" placeholder="Agency Password" />
                                ...
                                <h6 class="text-white text-uppercase"><a href="../Pages/SignUpAgency.php">Sign up</a></h6>
                            </div>
