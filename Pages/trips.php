        ...
        <div class="     py-5">
            <div class="row justify-content-center py-5">
                <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Find your Trip</h1>
                            ...
                            <div class="col-md-6">
                                <form>
                                    <div class="row g-10">
                                        ...
                                        <div class="col-md-6"> 
                                            <select  id='wilaya' style="background:#c3e2e8; height:58px; border-radius: 20px;" >
                    ...
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <a href="trip.php" class="btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
